...
<body>
  ...
  boolean flag=(Boolean)session.getAttribute("flag");
	...
	%>
        ...
        <input type="button" class="bt" id="bt21" onClick="modifyFeature()" value="修改要素" />
        <input type="button" class="bt" id="bt22" onClick="deleteFeature();" value="删除要素" />
        <input type="button" class="bt" id="bt23" onClick="queryWfs();" value="专题数据" />
     <%
	 }
	 else 
	 {
